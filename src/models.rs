...
/* Difference between these structs and
   'New' structs is that these structs query
   existing tables from the Database and those
   annotated with 'New' are meant to allow us
